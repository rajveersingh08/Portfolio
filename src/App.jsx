...
<div className="flex flex-col justify-center space-y-4">
  ...
  <h1 id="typewriter" className="text-[#FF3E00] text-5xl truncate font-bold tracking-tighter py-2">
      <Typewriter
        words={['Hey👋 , I am Rajveer Singh ' , "Fullstack Software Engineer"  ]}
        loop={5}
        cursor
        cursorStyle='|'
        typeSpeed={70}
...
<Card>
  <CardHeader>
    <img
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxntj1vjf2LWzgh_6cjHImWsSUrVdnabiKhw&s"
      width="550"
      height="310"
      alt="Project 1"
...
<Card>
  ...
  <CardContent>
    <div className="grid gap-1">
      ...
      <p className="text-sm text-muted-foreground">
        A Simple video project including Html and Tailwind Css.
      </p>
    </div>
    <div className="flex gap-2 mt-4">
      <div
...
<img
  src="https://cdn3d.iconscout.com/3d/free/thumb/free-css3-4387639-3640300.png?f=webp"
  width="100"
  height="100"
  alt="React"
  className="mx-auto rounded-full shadow-lg"
